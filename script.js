document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateRate() {
        var rateval = document.getElementById("rate").value; // Get the current slider value
        document.getElementById("rate_val").innerText = rateval; // Update the displayed value
    }
});
